...
namespace HeterogeneousDataSource.Conventions.Tests.DefaultConventions
{
    ...
    [TestFixture]
    public class LoadLinkSingleValueNestedLinkedSourceWhenIdSuffixMatchesTests {
        [Test]
        public void GetLinkedSourceTypes(){
            ...
            loadLinkProtocolBuilder.ApplyConventions(
                ...
                new List<ILoadLinkExpressionConvention> { new LoadLinkSingleValueNestedLinkedSourceWhenIdSuffixMatches() }
            );
