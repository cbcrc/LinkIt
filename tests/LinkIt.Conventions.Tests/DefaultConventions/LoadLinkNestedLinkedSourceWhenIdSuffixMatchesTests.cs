...
{
    public class LoadLinkNestedLinkedSourceWhenIdSuffixMatchesTests
    {
        [Fact]
        ...
        private static ILoadLinkProtocol BuildLoadLinkProtocol()
        {
            ...
            loadLinkProtocolBuilder.ApplyConventions(
                ...
                new List<ILoadLinkExpressionConvention> { new LoadLinkNestedLinkedSourceWhenIdSuffixMatches() }
            );
