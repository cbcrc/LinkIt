...
{
    public class LoadLinkNestedLinkedSourceFromModelWhenNameMatchesTests
    {
        [Fact]
        ...
        private static ILoadLinkProtocol BuildLoadLinkProtocol()
        {
            ...
            loadLinkProtocolBuilder.ApplyConventions(
                ...
                new List<ILoadLinkExpressionConvention> { new LoadLinkNestedLinkedSourceFromModelWhenNameMatches() }
            );
